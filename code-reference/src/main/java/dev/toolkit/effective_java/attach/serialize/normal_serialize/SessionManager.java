...
public class SessionManager {
    ...
    public static void saveSessionBySer(UserSession session) {
        try {
    ...
    // .ser 역직렬화 (.ser - 바이너리)
    public static UserSession loadSessionBySer() {
        try {
    ...
    //JSON 직렬화 (.json)
    public static void saveUserSessionByJson(UserSession session) {
        try {
    ...
    //JSON 역직렬화 (.json)
    public static UserSession loadUserSessionByJson() {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("------------------------------------------------");
        // ✅ 객체 직렬화 (.ser 파일에 저장 )
        SessionManager.saveSessionBySer(session);
        System.out.println();

        // ✅ 객체 역직렬화 (.ser 파일에서 읽기)
        UserSession loadSessionBySer = SessionManager.loadSessionBySer();
        ...
        // ✅ 객체 직렬화 (.json 파일에 저장 )
        SessionManager.saveUserSessionByJson(session);
        System.out.println();

        // ✅ 객체 역직렬화 (.json 파일에서 읽기)
        UserSession loadSessionByJson = SessionManager.loadUserSessionByJson();
        ...
        SessionManager.saveSessionAsProtobuf(session);
        System.out.println();

        // ✅ Protobuf 역직렬화 (.proto 파일에서 읽기)
        UserSession loadSessionByProto = SessionManager.loadSessionFromProtobuf();
